...
//Edit CRF
if(isset($_GET['editcrf'])){
	$id = $_GET['result_id'];

	$sql = mysqli_query($con,"SELECT * FROM result WHERE id='$id'") or die(mysqli_error($con));
	...
	?>
		<form class="form">
			...
			<div class="form-group">
				<label>CRF</label>
				<input type="text" name="lab_no" value="<?php echo $row['lab_no'];?>" class="form-control">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>Time</label>
				<input type="text" name="time_sampling" value="<?php echo $row['time_sampling'];?>" class="form-control">
			</div>
			<div class="form-group">
				<label>Type</label>
			...
			<div class="form-group">
				<label>SOP</label>
				<input type="text" name="sop" value="<?php echo $row['sop'];?>" class="form-control">
			</div>
			<div class="form-group">
				<label>Lab Fee</label>
				<input type="text" name="lab_offc" value="<?php echo $row['lab_offc'];?>" class="form-control">
			</div>
			<div class="form-group">
				<input type="submit" name="update_crf" value="UPDATE" class="btn btn-primary">
			</div>
		</form>
	<?php
}
